...
blue = (0, 0, 255)
white = (255, 255, 255)
whiteLine = [white for i in range(8)]
...
def update_screen(mode, show_letter = False):
  ...
  pressure_value = (pressure - 260) / 60
  ##pixels = [green if i < pressure_value else white for i in range(64)]

  humidity = sense.humidity
  humidity_value = humidity / 6
  ##pixels = [blue if i < humidity_value else white for i in range(64)]
  pixels = [red if i < temp_value else white for i in range(16)] + whiteLine + [green if i < pressure_value else white for i in range(16)] + whiteLine + [blue if i < humidity_value else white for i in range(16)]
